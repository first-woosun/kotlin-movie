...
class ApplicationTest(
    ...
    private fun insertTestData(conn: java.sql.Connection) {
        ...
        statement.execute("INSERT INTO MOVIE (id, title, running_time, start_date, end_date) VALUES (1, '테스트 영화', 120, '2026-04-01', '2026-04-30')")
        statement.execute("INSERT INTO SCREENING_SCHEDULE (id, movie_id, start_time, end_time, screening_date) VALUES (1, 1, '10:00', '12:00', '2026-04-03')")
        statement.execute("INSERT INTO SCREENING_SCHEDULE (id, movie_id, start_time, end_time, screening_date) VALUES (2, 1, '13:00', '15:00', '2026-04-03')")
        statement.execute("INSERT INTO SCREENING_SCHEDULE (id, movie_id, start_time, end_time, screening_date) VALUES (3, 1, '16:00', '18:00', '2026-04-03')")
    }
    ...
    fun `영화 목록 조회 응답에 영화와 상영 정보가 올바르게 포함된다`() {
        client.get().uri("/api/movies")
            ...
            .jsonPath("$.movies[0].title").isEqualTo("테스트 영화")
            .jsonPath("$.movies[0].runningTimeMinutes").isEqualTo(120)
